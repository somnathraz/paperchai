 ...
 */
export async function shouldSkipMilestoneAutomation(
  milestoneId: string
  ...
  if (!milestone.autoRemindersEnabled) {
    return {
      ...
      milestone: {
        ...
        lastManualActionAt: milestone.lastManualActionAt,
      },
    };
  }
...
export async function getMilestonesForAutomation(projectId?: string) {
  ...
  const where: any = {
    ...
    OR: [{ lastManualActionAt: null }, { lastManualActionAt: { lt: gracePeriodDate } }],
  };
