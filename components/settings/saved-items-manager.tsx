...
export type SavedItemsManagerProps = {
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => setSettings({ ...settings, defaultTaxRate: parseFloat(v) })}
            >
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => setSettings({ ...settings, paymentTerms: v })}
            >
              <SelectTrigger className="mt-1">
                <SelectValue />
              </SelectTrigger>
      ...
      <section className="rounded-2xl border border-border/60 bg-white p-6 shadow-sm">
        ...
        {filteredItems.length === 0 ? (
          <div className="text-center py-12 text-muted-foreground">
            ...
            <p className="text-sm">Add items to quickly use them in your invoices.</p>
          </div>
        ) : (
              ...
              <div key={item.id} className="flex items-center justify-between py-3 group">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3 text-sm text-muted-foreground">
                    ...
                    {item.taxRate !== null && <span>{item.taxRate}% tax</span>}
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {editingItem?.id ? "Update this saved item." : "Create a new item for your library."}
            </DialogDescription>
          </DialogHeader>
