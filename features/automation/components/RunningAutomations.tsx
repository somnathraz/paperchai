...
import { AutomationRun } from "@/lib/api/services/automation.service";

// Using local components/memo inside the file for now, similar to previous structure
// but connected to Redux hook
...
export const RunningAutomations = memo(function RunningAutomations() {
    const { stats, isLoading, error } = useAutomation();
    ...
    const { running, completed, failed } = stats || { running: [], completed: [], failed: [] };
