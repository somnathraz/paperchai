      ...
      <div className="rounded-2xl border border-border bg-card/50 p-4 backdrop-blur-sm">
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="text-orange-600 text-xs bg-orange-50 px-2 py-0.5 rounded-full">
              Late (2x)
            </span>
          </div>
          <div className="flex items-center justify-between text-sm">
            <span className="font-medium">Rahul S.</span>
            <span className="text-red-600 text-xs bg-red-50 px-2 py-0.5 rounded-full">
              Unresponsive
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              &quot;Switch <span className="font-medium text-foreground">Global Ind.</span> to
              WhatsApp reminders. They haven&apos;t opened 3 emails.&quot;
            </p>
          </div>
        </div>
      </div>
