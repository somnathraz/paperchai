...
function iconFor(
  type: "reminder" | "invoice" | "reliability" | "client" | "payment",
  description?: string
) {
      ...
      <div className="mt-4 space-y-3">
        ...
        {recentActivity.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className="flex items-start gap-3 rounded-2xl border border-border/60 bg-card/70 px-4 py-3 shadow-inner"
            >
