          ...
          {documents.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-slate-400 mt-1">
                Upload contracts, proposals, or other project files.
              </p>
            </div>
          ) : (
            documents.map((doc: any) => (
              <div
                key={doc.id}
                className="flex items-start justify-between border p-3 rounded-lg hover:bg-slate-50 transition-colors"
              >
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      {new Date(doc.createdAt).toLocaleDateString()} • {doc.sourceType}
                    </p>
                    {doc.aiSummary && (
