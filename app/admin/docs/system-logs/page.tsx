  ...
  return (
    <div className="max-w-6xl space-y-8 pb-20">
      ...
      <Callout type="tip" title="Implementation Location">
        All audit logging is implemented in <code>lib/security/audit-log.ts</code> and stored in the{" "}
        <code>AuditLog</code> Prisma model.
      </Callout>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-xs">
                        action, userId, workspaceId, request, metadata?
                      </TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-xs">
                        action, userId, workspaceId, targetUserId, request, metadata?
                      </TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-xs">
                        action, userId, workspaceId, invoiceId, request, metadata?
                      </TableCell>
              ...
              <Card className="md:col-span-2">
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    CRON events use <code>userId: &quot;SYSTEM&quot;</code> since they run without a
                    user context.
                  </p>
                </CardContent>
              </Card>
        ...
        <DocsTabsContent value="usage">
          <div className="space-y-6">
            <Callout type="warning" title="Error Resilience">
              Audit logging is wrapped in try-catch and will <strong>never</strong> break the main
              request flow. Errors are logged to console.
            </Callout>
