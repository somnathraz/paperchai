    ...
    <div className="max-w-6xl space-y-8 pb-20">
      ...
      <Callout type="tip" title="Architecture Overview">
        <ul className="list-disc pl-5 mt-2 space-y-1 text-sm">
          <li>
            <strong>Next.js API Routes</strong> in <code>app/api/</code> with Route Handlers
          </li>
          <li>
            <strong>Prisma ORM</strong> for PostgreSQL database access
          </li>
          <li>
            <strong>NextAuth.js</strong> for authentication (Google OAuth + Credentials)
          </li>
          <li>
            <strong>Centralized Security</strong> in <code>lib/security/</code>
          </li>
        </ul>
      </Callout>
      ...
      <DocsTabs defaultValue="overview">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    ...
                    <div
                      key={item.path}
                      className="bg-slate-50 dark:bg-slate-900 p-3 rounded border"
                    >
        ...
        <DocsTabsContent value="security">
          <div className="space-y-6">
            <Callout type="warning" title="Security First">
              All API routes should use the centralized security utilities in{" "}
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell>
                        Central config: rate limits, tiers, roles, audit actions
                      </TableCell>
                    </TableRow>
                    <TableRow>
          ...
          <div className="space-y-6">
            ...
            <RouteTable
              ...
              routes={[
                ...
                {
                  method: "POST",
                  path: "/api/projects/[id]/extract-billable-items",
                  desc: "Extract billable items",
                },
              ]}
            />

            <RouteTable
              category="Items & Milestones"
              routes={[
                ...
                {
                  method: "POST",
                  path: "/api/milestones/[id]/manual-action",
                  desc: "Complete/paid",
                },
              ]}
            />
        ...
        <DocsTabsContent value="dashboard">
          <div className="space-y-6">
            ...
            <RouteTable
              category="Dashboard Endpoints (6)"
              routes={[
                {
                  method: "GET",
                  path: "/api/dashboard/stats",
                  desc: "Revenue, outstanding, reliability metrics",
                },
                {
                  method: "GET",
                  path: "/api/dashboard/cashflow",
                  desc: "Monthly cashflow data for charts",
                },
                { method: "GET", path: "/api/dashboard/invoices", desc: "Recent invoices list" },
                {
                  method: "GET",
                  path: "/api/dashboard/reminders",
                  desc: "Upcoming reminders queue",
                },
                {
                  method: "GET",
                  path: "/api/dashboard/recent-activity",
                  desc: "Activity feed data",
                },
                {
                  method: "GET",
                  path: "/api/dashboard/automation",
                  desc: "Automation status summary",
                },
              ]}
            />
  ...
  outstandingSparkline: number[]
        ...
        <DocsTabsContent value="ai">
          <div className="space-y-6">
            ...
            <RouteTable
              category="Generative AI (5 endpoints)"
              routes={[
                {
                  method: "POST",
                  path: "/api/ai/invoice/generate",
                  desc: "Generate invoice from prompt",
                },
                {
                  method: "POST",
                ...
                {
                  method: "POST",
                  path: "/api/ai/projects/extract",
                  desc: "Extract project from contract",
                },
                { method: "POST", path: "/api/ai/notion/extract", desc: "Analyze Notion page" },
                {
                  method: "POST",
                  path: "/api/ai/slack/extract",
                  desc: "Extract from Slack thread",
                },
              ]}
            />
            ...
            <Card>
              ...
              <CardContent className="text-sm space-y-2">
                <p>
                  Uses <code>@google/generative-ai</code> SDK with Gemini 1.5 Flash model.
                </p>
              ...
              routes={[
                {
                  ...
                  desc: "Connection status for all integrations",
                },
                {
                  method: "GET",
                  path: "/api/integrations/automations",
                  desc: "List running automations",
                },
        ...
        <DocsTabsContent value="auth">
          <div className="space-y-6">
            <RouteTable
              category="Authentication (6 endpoints)"
              routes={[
            ...
            <RouteTable
              category="Workspace Management (6 endpoints)"
              routes={[
              ...
              routes={[
                {
                  ...
                  desc: "Process due reminders queue",
                },
                {
                  method: "POST",
                  path: "/api/internal/scheduled-invoices/run",
                  desc: "Send scheduled invoices",
                },
              ]}
            />
