    ...
    <div className="max-w-6xl space-y-8 pb-20">
      ...
      <Callout type="tip" title="Architecture Overview">
        <ul className="list-disc pl-5 mt-2 space-y-1 text-sm">
          <li>
            <strong>Next.js 14 App Router</strong> with Server Components for data fetching
          </li>
          <li>
            <strong>Feature-based organization</strong> in <code>features/</code> directory
          </li>
          <li>
            <strong>Redux Toolkit</strong> for complex client state (editor, UI)
          </li>
          <li>
            <strong>Prisma</strong> for database access in Server Components
          </li>
        </ul>
      </Callout>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-lg border">
                    <p className="font-semibold text-sm mb-2">
                      Redux: <code>lib/store/slices/editorSlice.ts</code>
                    </p>
                  ...
                  <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-lg border">
                    <p className="font-semibold text-sm mb-2">
                      Utils: <code>features/invoices/utils/</code>
                    </p>
                    <ul className="text-xs space-y-1 text-muted-foreground">
                      <li>
                        <code>calculations.ts</code> - Tax, totals
                      </li>
                      <li>
                        <code>index.ts</code> - Exports
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <DocsTabsContent value="dashboard">
          <div className="space-y-6">
            <Callout type="note" title="Hybrid Fetching">
              Dashboard uses Server Components for layout + Client Components with hooks for
              real-time stats.
            </Callout>
              ...
              <Card>
                ...
                <CardContent className="text-sm">
                  ...
                  <p className="text-muted-foreground mt-2">
                    Toggle Slack notifications for reminders
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent className="text-sm">
                  ...
                  <p className="text-muted-foreground mt-2">
                    reminderSlice: queue, filters, health stats
                  </p>
                </CardContent>
              </Card>
            </div>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      25KB - Multi-step wizard for importing from Notion
                    </p>
                  </div>
                  <div>
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="font-mono text-xs">
                        lib/store/slices/editorSlice.ts
                      </TableCell>
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    {
                      feature: "dashboard",
                      path: "features/dashboard/store/",
                      desc: "Stats, activity, cashflow",
                    },
                    {
                      feature: "reminders",
                      path: "features/reminders/store/",
                      desc: "Queue, filters, health",
                    },
                    {
                      feature: "automation",
                      path: "features/automation/store/",
                      desc: "Running imports, status",
                    },
                    {
                      feature: "clients",
                      path: "features/clients/store/",
                      desc: "Client list, selected",
                    },
                  ].map((item) => (
                    <div
                      key={item.feature}
