...
import { Book, LayoutDashboard, Database, Server, ShieldCheck, Code } from "lucide-react";
        ...
        <nav className="flex-1 overflow-y-auto py-6 px-4 space-y-6">
          ...
          <div>
            ...
            <div className="space-y-1">
              ...
              <NavLink href="/admin/feature-flags" icon={ShieldCheck}>
                Feature Flags
              </NavLink>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-1">
              <NavLink href="/admin/docs" icon={Book}>
                Introduction
              </NavLink>
              <NavLink href="/admin/docs/frontend" icon={LayoutDashboard}>
                Frontend Arch
              </NavLink>
              <NavLink href="/admin/docs/backend" icon={Server}>
                Backend API
              </NavLink>
              <NavLink href="/admin/docs/database" icon={Database}>
                Database Schema
              </NavLink>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-1">
              <NavLink href="/admin/system-logs" icon={Code}>
                System Logs
              </NavLink>
            </div>
          </div>
